...
%% ---------------------------
% SETTINGS 
freqs = [7.5,12]; % what frequecies, should be frequencies that the monitor can achieve
...
trial_length = 30; % how long do you want each trial to be? recommend at least 5 seconds
